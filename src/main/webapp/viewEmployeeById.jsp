...
<jsp:include page="admininclude.jsp"/>
    <div class="container">
        ...
        <div class="form-container">
            <form action="viewEmployeeById.jsp" method="get">
        ...
        <%
            // Get the employeeId parameter from the request
            String employeeId = request.getParameter("employeeId");

            // If employeeId is provided, fetch employee details from the database
