...
<jsp:include page="admininclude.jsp"/>
    <div class="container">
        ...
        <div class="form-container">
            <form action="viewProjectById.jsp" method="get">
        ...
        <% 
            ...
            String employeeName = null; // Variable to store employee name
            ...
            if (projectId != null && !projectId.isEmpty()) {
                ...
                try {
                    ...
                    // SQL query to get project details by projectId and employee name by employeeId
                    String sql = "SELECT p.*, e.employee_name FROM project p " +
                    ...
                    if (resultSet.next()) {
                        ...
                        // Get employee name
                        employeeName = resultSet.getString("e.employee_name");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                } finally {
        ...
        <div class="project-info">
            ...
            <table>
                ...
                <tr>
                    <th>Employee Name</th>
                    <td><%= employeeName %></td> <!-- Display Employee Name -->
                </tr>
            </table>
        </div>
        <% 
